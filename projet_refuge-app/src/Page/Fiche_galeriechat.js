...
const Fichegalerie = () => {
    const cat = [
        { name: "Oreo", age: "1 An 1/2", race: "Lorem", Sexe: "Mâle stérilisé", imgSrc: "/img/img_galeriechat/oreo_1.2.jpg" },
        ...
        { name: "Luna", age: "7 Mois", race: "Européen", Sexe: "Femelle stérilisé", imgSrc: "/img/img_galeriechat/lune_1.2.jpg" },
        { name: "Gizmo", age: "7 Ans 1/2", race: "Européen", Sexe: "Mâle stérilisé", imgSrc: "/img/img_galeriechat/chat_pexels_1.3.jpg" },
        { name: "Misty", age: "8 Ans", race: "Européen", Sexe: "Femelle stérilisé", imgSrc: "/img/img_galeriechat/chat_grisblanc_1.3.png" },
        { name: "Leo", age: "3 Ans", race: "Européen", Sexe: "Mâle stérilisé", imgSrc: "/img/img_galeriechat/chat_grisligne_1.3.png" },
    ];
