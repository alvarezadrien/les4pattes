...
const Compagnons_adopter = () => {
    ...
    if (!animaux.length)
        return (
            <p className="no-compagnon-message">
                Aucun compagnon adopté pour l’instant. Revenez vite !
            </p>
        );
        ...
        <div className="page_compagnons">
            <header className="compagnons_header">
                ...
                <p className="paragraphe_compagnons">
                    Chaque adoption est une magnifique histoire ! Découvrez
                    les animaux qui ont trouvé leur foyer pour la vie. Merci à
                    toutes les familles qui ont ouvert leur cœur et offert une
                    seconde chance à nos amis à quatre pattes.
                </p>
            </header>
